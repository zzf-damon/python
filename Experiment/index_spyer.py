...
for num in range(0, 50000):
    URL_BIG = 'https://www.jufaanli.com/album/tanwutryout/lawyerSearch?TypeKey=&Page={}'.format(
        num)
    post = {}
    user = "15949527066"
    password = "mxd66ilove"
    ...
    driver.find_element_by_xpath(
        "//div[@class='col-lg-9 jufa-col-lg-9']/input[@id='userObj']").clear()
    # 自动填入登录用户名
    driver.find_element_by_xpath(
        "//div[@class='col-lg-9 jufa-col-lg-9']/input[@id='userObj']").send_keys(user)
    # 清空密码框
    driver.find_element_by_xpath(
        "//div[@class='col-lg-9 jufa-col-lg-9']/input[@id='pwdObj']").clear()
    # 自动填入登录密码
    driver.find_element_by_xpath(
        "//div[@class='col-lg-9 jufa-col-lg-9']/input[@id='pwdObj']").send_keys(password)
    ...
    for i in search_list:
        ...
        url_i = "https://www.jufaanli.com/album/tanwutryout/wenshu/{}/?q=&src=search".format(
            uuid)
        time.sleep(3)
        user = "15949527066"
        password = "mxd66ilove"
